...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'log_event') {
        ...
        $stmt = $pdo->prepare("INSERT INTO game_events (game_id, parent_email, event_type, player_id, player_out_id, event_minute, is_confirmed) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$gameId, $parentEmail, $eventType, $playerId, $playerOutId, $eventMinute, $isCoach]);
