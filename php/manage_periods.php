...
<div class="container mt-4 mb-5">
    ...
    <div class="alert alert-info border-0 shadow-sm">
        ...
        Splits je seizoen op in logische blokken (bv. Voorbereiding, Heenronde, Terugronde deel 1). Je kan deze blokken later op de statistiekenpagina gebruiken als filter.<br>
                        ...
                        <div class="row g-2 mb-3 period-row align-items-end">
                            ...
                            <div class="col-md-3 position-relative">
                                ...
                                <div class="quick-links d-none text-center position-absolute w-100" style="font-size:0.75rem; top: 100%; left: 0; margin-top: 2px; z-index: 10;">
                                    ...
                                    <a href="#" class="text-decoration-none me-1 set-duration" data-weeks="5">+5w</a>
                                    <a href="#" class="text-decoration-none me-1 set-duration" data-weeks="6">+6w</a>
                                    <a href="#" class="text-decoration-none me-1 set-duration" data-weeks="7">+7w</a>
                                    <a href="#" class="text-decoration-none me-1 set-duration" data-weeks="8">+8w</a>
                                    <a href="#" class="text-decoration-none me-1 set-duration" data-weeks="9">+9w</a>
                                    <a href="#" class="text-decoration-none set-duration" data-weeks="10">+10w</a>
                                </div>
                            </div>
                            <div class="col-md-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    container.addEventListener('click', function(e) {
        ...
        if (e.target.classList.contains('set-duration')) {
            e.preventDefault();
    ...
    function syncAllDates() {
        ...
        for(let i=0; i<rows.length; i++) {
            ...
            if (startInput.value && endInput.value) {
                let sD = new Date(startInput.value);
                let eD = new Date(endInput.value);
                let diffTime = Math.abs(eD - sD) + (24 * 60 * 60 * 1000); // include start day
                let diffDays = Math.floor(diffTime / (1000 * 60 * 60 * 24));
                let weeks = Math.round((diffDays / 7) * 10) / 10;
                let lbl = row.querySelector('.duration-label');
                if (lbl) lbl.textContent = '(' + weeks + 'w)';
            }
            
            // Sync next row start date
            if (i < rows.length - 1 && endInput.value) {
