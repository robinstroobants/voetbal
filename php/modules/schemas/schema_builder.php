...
// Alleen opgeslagen block_labels gebruiken als het een tornooi is
if (!$is_tournament) {
    $game_block_labels = [];
}
...
$min_pos_val = (int)($matchData['game']['min_pos'] ?? 0);
$min_pos_label = match($min_pos_val) {
    2 => 'Min. 2 pos.',
    3 => 'Min. 3 pos.',
    default => 'Geen pos. limiet'
};
        ...
        let html = `
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center w-75">
                    <span id="label-${shiftIdx}" class="fw-bold text-dark fs-5">${def.label}</span>
