<?php
$shuffle_type = "random";
$te_gebruiken_schema = 0; //628; //219;
$max_runs = 7500;
$shuffle_type = "coach";
$te_gebruiken_schema = 1032;
$selectie = "Miel, Léno, Rune, Scout, Seppe, Jayden, Arda, Thibo, Jack, MuratC";

//$shuffle_type = "coach";
//$te_gebruiken_schema = 1032;
//$no_max_players = "Thibo,Miel"; //spelers die niet op een positie mogen staan die het meeste speelt
//$no_min_players = "Jack,Jayden"; // spelers die niet op een positie mogen staan die het minst speelt
